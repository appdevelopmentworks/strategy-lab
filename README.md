...
![Strategies](https://img.shields.io/badge/strategies-62-green)
![License](https://img.shields.io/badge/license-MIT-yellow)

## 概要

StrategyLabは、62種類のトレード戦略を自動でバックテストし、最適な戦略とパラメーターを発見するためのWebアプリケーションです。
