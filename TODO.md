...
## v1.5.1 ユーザーマニュアル・UI改善（NEW）

### ユーザーマニュアル
| 機能 | 形式 | アクセス | 状態 |
|------|------|--------|------|
| 使い方ヘルプ | スライドパネル | ヘッダー「?」ボタン | ✅ |
| 戦略ガイド | 別ページ /docs | ヘッダー「📖」ボタン | ✅ |

### UI改善
- ✅ 中央揃えレイアウト（最大幅1400px）
- ✅ チャートシグナル表示改善（「買」「売」→「Entry」「Exit」）
- ✅ ファビコン・OGP設定（猫アイコン）
- ✅ ヘッダーアイコン追加

### 技術的改善
- ✅ yahoo-finance2 v2→v3移行（historical→chart API）
- ✅ 期間別最低データ日数設定
- ✅ グリッドサーチUIのnullチェック追加
...
- 2024-12-25: v1.5.1 - ユーザーマニュアル・UI改善・MVP完了🎉
